    ...
    ui(new Ui::qrobot)
{
    ...
    cv::createTrackbar("LowH", "Control", &iLowHD, 179); //Hue (0 - 179)
    cv::createTrackbar("HighH", "Control", &iHighHD, 179);

	cv::createTrackbar("LowH", "Control", &iLowHU, 179); //Hue (0 - 179)
    cv::createTrackbar("HighH", "Control", &iHighHU, 179);
...
void qrobot::img_proc()
{
    ...
    cv::Mat imgThresholdedD;
    cv::Mat imgThresholdedU;

    cv::inRange(imgHSV, cv::Scalar(iLowHD, iLowS, iLowV), cv::Scalar(iHighHD, iHighS, iHighV), imgThresholdedD);
    cv::inRange(imgHSV, cv::Scalar(iLowHU, iLowS, iLowV), cv::Scalar(iHighHU, iHighS, iHighV), imgThresholdedU);
    imgThresholded =  imgThresholdedD +  imgThresholdedU;
